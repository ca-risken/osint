...
type RelOsintDetectWord struct {
	...
	RelOsintDetectWordId uint32 `protobuf:"varint,1,opt,name=rel_osint_detect_word_id,json=relOsintDetectWordId,proto3" json:"rel_osint_detect_word_id,omitempty"`
	...
	OsintDetectWordId    uint32 `protobuf:"varint,3,opt,name=osint_detect_word_id,json=osintDetectWordId,proto3" json:"osint_detect_word_id,omitempty"`
	ProjectId            uint32 `protobuf:"varint,4,opt,name=project_id,json=projectId,proto3" json:"project_id,omitempty"`
	CreatedAt            int64  `protobuf:"varint,5,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty"`
	UpdatedAt            int64  `protobuf:"varint,6,opt,name=updated_at,json=updatedAt,proto3" json:"updated_at,omitempty"`
}

func (x *RelOsintDetectWord) Reset() {
	*x = RelOsintDetectWord{}
	if protoimpl.UnsafeEnabled {
...
func (x *RelOsintDetectWord) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RelOsintDetectWord) ProtoMessage() {}

func (x *RelOsintDetectWord) ProtoReflect() protoreflect.Message {
	mi := &file_osint_entities_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RelOsintDetectWord.ProtoReflect.Descriptor instead.
func (*RelOsintDetectWord) Descriptor() ([]byte, []int) {
	return file_osint_entities_proto_rawDescGZIP(), []int{6}
}

func (x *RelOsintDetectWord) GetRelOsintDetectWordId() uint32 {
	if x != nil {
...
func (x *RelOsintDetectWord) GetRelOsintDataSourceId() uint32 {
	if x != nil {
		return x.RelOsintDataSourceId
	}
	return 0
...
func (x *RelOsintDetectWord) GetOsintDetectWordId() uint32 {
	if x != nil {
...
func (x *RelOsintDetectWord) GetProjectId() uint32 {
	if x != nil {
		return x.ProjectId
	}
	return 0
...
func (x *RelOsintDetectWord) GetCreatedAt() int64 {
	if x != nil {
		return x.CreatedAt
	}
	return 0
...
func (x *RelOsintDetectWord) GetUpdatedAt() int64 {
	if x != nil {
		return x.UpdatedAt
	}
	return 0
...
type RelOsintDetectWordForUpsert struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *RelOsintDetectWordForUpsert) Reset() {
	*x = RelOsintDetectWordForUpsert{}
	if protoimpl.UnsafeEnabled {
...
func (x *RelOsintDetectWordForUpsert) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RelOsintDetectWordForUpsert) ProtoMessage() {}

func (x *RelOsintDetectWordForUpsert) ProtoReflect() protoreflect.Message {
	mi := &file_osint_entities_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RelOsintDetectWordForUpsert.ProtoReflect.Descriptor instead.
func (*RelOsintDetectWordForUpsert) Descriptor() ([]byte, []int) {
	return file_osint_entities_proto_rawDescGZIP(), []int{7}
}

func (x *RelOsintDetectWordForUpsert) GetRelOsintDetectWordId() uint32 {
	if x != nil {
		return x.RelOsintDetectWordId
	}
	return 0
...
func (x *RelOsintDetectWordForUpsert) GetRelOsintDataSourceId() uint32 {
	if x != nil {
		return x.RelOsintDataSourceId
	}
	return 0
...
func (x *RelOsintDetectWordForUpsert) GetOsintDetectWordId() uint32 {
	if x != nil {
		return x.OsintDetectWordId
	}
	return 0
...
func (x *RelOsintDetectWordForUpsert) GetProjectId() uint32 {
	if x != nil {
		return x.ProjectId
	}
	return 0
...
func (x *OsintDetectWord) Reset() {
	*x = OsintDetectWord{}
	if protoimpl.UnsafeEnabled {
		mi := &file_osint_entities_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*OsintDetectWord) Descriptor() ([]byte, []int) {
	return file_osint_entities_proto_rawDescGZIP(), []int{8}
}
...
func (x *OsintDetectWordForUpsert) Reset() {
	*x = OsintDetectWordForUpsert{}
	if protoimpl.UnsafeEnabled {
		mi := &file_osint_entities_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*OsintDetectWordForUpsert) Descriptor() ([]byte, []int) {
	return file_osint_entities_proto_rawDescGZIP(), []int{9}
}
...
var file_osint_entities_proto_rawDesc = []byte{
	...
	0x18, 0x07, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x73, 0x63, 0x61, 0x6e, 0x41, 0x74, 0x22, 0x92,
	0x02, 0x0a, 0x12, 0x52, 0x65, 0x6c, 0x4f, 0x73, 0x69, 0x6e, 0x74, 0x44, 0x65, 0x74, 0x65, 0x63,
	0x74, 0x57, 0x6f, 0x72, 0x64, 0x12, 0x36, 0x0a, 0x18, 0x72, 0x65, 0x6c, 0x5f, 0x6f, 0x73, 0x69,
	...
	0x74, 0x44, 0x65, 0x74, 0x65, 0x63, 0x74, 0x57, 0x6f, 0x72, 0x64, 0x49, 0x64, 0x12, 0x36, 0x0a,
	...
	0x72, 0x63, 0x65, 0x49, 0x64, 0x12, 0x2f, 0x0a, 0x14, 0x6f, 0x73, 0x69, 0x6e, 0x74, 0x5f, 0x64,
	0x65, 0x74, 0x65, 0x63, 0x74, 0x5f, 0x77, 0x6f, 0x72, 0x64, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x0d, 0x52, 0x11, 0x6f, 0x73, 0x69, 0x6e, 0x74, 0x44, 0x65, 0x74, 0x65, 0x63, 0x74,
	0x57, 0x6f, 0x72, 0x64, 0x49, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63,
	...
	0x64, 0x41, 0x74, 0x22, 0xdd, 0x01, 0x0a, 0x1b, 0x52, 0x65, 0x6c, 0x4f, 0x73, 0x69, 0x6e, 0x74,
	0x44, 0x65, 0x74, 0x65, 0x63, 0x74, 0x57, 0x6f, 0x72, 0x64, 0x46, 0x6f, 0x72, 0x55, 0x70, 0x73,
	0x65, 0x72, 0x74, 0x12, 0x36, 0x0a, 0x18, 0x72, 0x65, 0x6c, 0x5f, 0x6f, 0x73, 0x69, 0x6e, 0x74,
	...
	,
	...
	,
	...
	0x45, 0x52, 0x52, 0x4f, 0x52, 0x10, 0x04, 0x42, 0x30, 0x5a, 0x2e, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_osint_entities_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_osint_entities_proto_goTypes = []interface{}{
	...
	(*RelOsintDetectWord)(nil),          // 7: osint.osint.RelOsintDetectWord
	(*RelOsintDetectWordForUpsert)(nil), // 8: osint.osint.RelOsintDetectWordForUpsert
	(*OsintDetectWord)(nil),             // 9: osint.osint.OsintDetectWord
	(*OsintDetectWordForUpsert)(nil),    // 10: osint.osint.OsintDetectWordForUpsert
}
...
func file_osint_entities_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_osint_entities_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RelOsintDetectWord); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_osint_entities_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RelOsintDetectWordForUpsert); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_osint_entities_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_osint_entities_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
