...
func TestValidate_ListOsintRelatedResourceRequest(t *testing.T) {
	cases := []struct {
		name    string
		input   *ListOsintRelatedResourceRequest
		wantErr bool
	}{
		{
			name:    "OK",
			input:   &ListOsintRelatedResourceRequest{ResourceName: "hogehoge.com", ResourceType: "Domain"},
			wantErr: false,
		},
		{
			name:    "NG Required(resource_name)",
			input:   &ListOsintRelatedResourceRequest{ResourceType: "Domain"},
			wantErr: true,
		},
		{
			name:    "NG Required(resource_type)",
			input:   &ListOsintRelatedResourceRequest{ResourceName: "hogehoge.com"},
			wantErr: true,
		},
		{
			name:    "NG Length(resource_name)",
			input:   &ListOsintRelatedResourceRequest{ResourceName: "123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901", ResourceType: "Domain"},
			wantErr: true,
		},
		{
			name:    "NG Length(resource_type)",
			input:   &ListOsintRelatedResourceRequest{ResourceName: "hogehoge.com", ResourceType: "123456789012345678901234567890123456789012345678901"},
			wantErr: true,
		},
	}
	for _, c := range cases {
